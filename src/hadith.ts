...
export const hadiths: Hadith[] = [
  ...
  { ar: 'لا ضرر ولا ضرار.', en: 'There should be neither harming nor reciprocating harm.', source: 'صحيح ابن ماجه 2340 (تصحيح الألباني)', narrator: 'عبادة بن الصامت' },
  ...
  { ar: 'أكمل المؤمنين إيماناً أحسنهم خلقاً.', en: 'The most complete of the believers in faith is the one with the best character.', source: 'صحيح أبي داود 4682، حسن صحيح (الترمذي 1162)', narrator: 'أبو هريرة' },
